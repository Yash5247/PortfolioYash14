        ...
        <main>
            ...
            <ScrollReveal delay={0.1}>
              <p className="mt-6 flex flex-wrap items-center justify-center gap-x-2 text-lg sm:text-xl">
                ...
                <Typewriter
                  ...
                  className="inline-block min-w-[14ch] text-left font-medium text-white"
                />
              </p>
            </ScrollReveal>
          ...
          <section className="relative py-8">
            <ScrollReveal>
              <div className="mx-auto max-w-5xl px-6">
                <div className="pro-card rounded-xl py-5">
                  <LogoLoop
          ...
          <section id="about" className="relative py-20">
            <div className="mx-auto grid max-w-6xl gap-10 px-6 lg:grid-cols-2 lg:items-center">
              <ScrollReveal>
                <div className="pro-card rounded-xl p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2.5 text-sm text-white/55">
                    <p>{personal.email}</p>
                    <p>{personal.phone}</p>
